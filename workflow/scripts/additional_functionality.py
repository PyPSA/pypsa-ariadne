...
def limit_total_import_de(n, snapshots, limit_de, investment_year):
    ...
    if "energy_total_import_limit_de" not in n.global_constraints.index:
        n.add(
            "GlobalConstraint",
            "energy_total_import_limit_de",
            constant=limit,
            sense="==",
            type="",
            carrier_attribute="",
