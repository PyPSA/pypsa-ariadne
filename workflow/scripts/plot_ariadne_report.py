...
carriers_in_german = {
    ...
    'offwind-ac': 'Offshore-Wind (Wechselstrom)',
    'offwind-dc': 'Offshore-Wind (Gleichstrom)',
    'solar': 'Solar',
    ...
    'land transport oil': 'Landtransportöl',
    ...
    'H2 for industry': 'Wasserstoff für die Industrie',
    ...
    'land transport fuel cell': 'Landtransport mit Brennstoffzellen',
    'land transport EV': 'Landtransport mit Elektrofahrzeugen',
    ...
    'SMR CC': 'Dampfreformierung mit CO2-Abscheidung',
    ...
    'Fischer-Tropsch': 'Fischer-Tropsch-Synthese',
    ...
    'H2 Electrolysis': 'Wasserstoffelektrolyse',
    ...
    'H2 Fuel Cell': 'Wasserstoff-Brennstoffzelle',
...
def plot_nodal_balance(
    ...
    if plot_lmps:
        ...
        ax2 = lmps.plot(
            style="--", color="black", label="Knotenpreise (gemittelt)", secondary_y=True
        )
        ax2.grid(False)
